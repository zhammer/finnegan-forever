...
def read_current_passage(scroll, passage_size, window_length, seconds):
    ...
    passage_offset = passage.current_passage_offset(scroll_size, passage_size, window_length, seconds)
